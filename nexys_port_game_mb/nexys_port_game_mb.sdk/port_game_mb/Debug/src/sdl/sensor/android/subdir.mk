...
C_SRCS += \
../src/sdl/sensor/android/SDL_androidsensor.c 

OBJS += \
./src/sdl/sensor/android/SDL_androidsensor.o 

C_DEPS += \
./src/sdl/sensor/android/SDL_androidsensor.d 


# Each subdirectory must supply rules for building sources it contributes
src/sdl/sensor/android/%.o: ../src/sdl/sensor/android/%.c
	@echo 'Building file: $<'

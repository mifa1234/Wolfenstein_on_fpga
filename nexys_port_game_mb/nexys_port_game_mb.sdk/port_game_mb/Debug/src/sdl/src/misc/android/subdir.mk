...
C_SRCS += \
../src/sdl/src/misc/android/SDL_sysurl.c 

OBJS += \
./src/sdl/src/misc/android/SDL_sysurl.o 

C_DEPS += \
./src/sdl/src/misc/android/SDL_sysurl.d 


# Each subdirectory must supply rules for building sources it contributes
src/sdl/src/misc/android/%.o: ../src/sdl/src/misc/android/%.c
	@echo 'Building file: $<'

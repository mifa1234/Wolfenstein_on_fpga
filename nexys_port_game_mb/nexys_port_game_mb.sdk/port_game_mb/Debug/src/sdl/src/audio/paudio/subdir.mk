...
C_SRCS += \
../src/sdl/src/audio/paudio/SDL_paudio.c 

OBJS += \
./src/sdl/src/audio/paudio/SDL_paudio.o 

C_DEPS += \
./src/sdl/src/audio/paudio/SDL_paudio.d 


# Each subdirectory must supply rules for building sources it contributes
src/sdl/src/audio/paudio/%.o: ../src/sdl/src/audio/paudio/%.c
	@echo 'Building file: $<'

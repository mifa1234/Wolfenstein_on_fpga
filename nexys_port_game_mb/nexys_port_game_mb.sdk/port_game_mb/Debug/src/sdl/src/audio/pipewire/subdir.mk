...
C_SRCS += \
../src/sdl/src/audio/pipewire/SDL_pipewire.c 

OBJS += \
./src/sdl/src/audio/pipewire/SDL_pipewire.o 

C_DEPS += \
./src/sdl/src/audio/pipewire/SDL_pipewire.d 


# Each subdirectory must supply rules for building sources it contributes
src/sdl/src/audio/pipewire/%.o: ../src/sdl/src/audio/pipewire/%.c
	@echo 'Building file: $<'

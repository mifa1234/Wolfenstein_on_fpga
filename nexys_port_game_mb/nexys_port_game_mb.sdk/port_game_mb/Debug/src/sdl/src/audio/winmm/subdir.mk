...
C_SRCS += \
../src/sdl/src/audio/winmm/SDL_winmm.c 

OBJS += \
./src/sdl/src/audio/winmm/SDL_winmm.o 

C_DEPS += \
./src/sdl/src/audio/winmm/SDL_winmm.d 


# Each subdirectory must supply rules for building sources it contributes
src/sdl/src/audio/winmm/%.o: ../src/sdl/src/audio/winmm/%.c
	@echo 'Building file: $<'

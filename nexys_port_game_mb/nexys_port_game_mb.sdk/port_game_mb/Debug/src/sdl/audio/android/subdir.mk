...
C_SRCS += \
../src/sdl/audio/android/SDL_androidaudio.c 

OBJS += \
./src/sdl/audio/android/SDL_androidaudio.o 

C_DEPS += \
./src/sdl/audio/android/SDL_androidaudio.d 


# Each subdirectory must supply rules for building sources it contributes
src/sdl/audio/android/%.o: ../src/sdl/audio/android/%.c
	@echo 'Building file: $<'

...
C_SRCS += \
../src/sdl/joystick/SDL_gamecontroller.c \
../src/sdl/joystick/SDL_joystick.c 

OBJS += \
./src/sdl/joystick/SDL_gamecontroller.o \
./src/sdl/joystick/SDL_joystick.o 

C_DEPS += \
./src/sdl/joystick/SDL_gamecontroller.d \
./src/sdl/joystick/SDL_joystick.d 


# Each subdirectory must supply rules for building sources it contributes
src/sdl/joystick/%.o: ../src/sdl/joystick/%.c
	@echo 'Building file: $<'

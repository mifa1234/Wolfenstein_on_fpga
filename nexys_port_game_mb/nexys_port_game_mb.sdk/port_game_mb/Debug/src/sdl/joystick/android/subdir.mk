...
C_SRCS += \
../src/sdl/joystick/android/SDL_sysjoystick.c 

OBJS += \
./src/sdl/joystick/android/SDL_sysjoystick.o 

C_DEPS += \
./src/sdl/joystick/android/SDL_sysjoystick.d 


# Each subdirectory must supply rules for building sources it contributes
src/sdl/joystick/android/%.o: ../src/sdl/joystick/android/%.c
	@echo 'Building file: $<'

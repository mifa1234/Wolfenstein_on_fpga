...
{
	xil_printf("\tin SDL_InitSubSystem \n\r");
    ...
    SDL_ClearError();
    xil_printf("\tafter SDL_ClearError() \n\r");
    ...
    if ((flags & SDL_INIT_EVENTS)) {
        ...
        xil_printf("\tafter SDL_PrivateSubsystemRefCountIncr \n\r");
    ...
    if ((flags & SDL_INIT_VIDEO)){
        ...
        xil_printf("\tafter SDL_PrivateSubsystemRefCountIncr 2 \n\r");
    ...
    if ((flags & SDL_INIT_JOYSTICK)){
        ...
        xil_printf("\tafter SDL_SetError 2\n\r");
        goto quit_and_error;
#endif
    }

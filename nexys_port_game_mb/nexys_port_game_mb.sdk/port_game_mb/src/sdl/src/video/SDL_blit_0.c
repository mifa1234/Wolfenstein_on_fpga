...
{
	xil_printf("SDL_blit_0.c:33   in BlitBto1\n\r");
    int c;
    int width, height;
    Uint8 *src, *map, *dst;
    int srcskip, dstskip;
...
{
	xil_printf("SDL_blit.c:89   in BlitBto2\n\r");
    int c;
    int width, height;
    Uint8 *src;
    Uint16 *map, *dst;
...
{
	xil_printf("SDL_blit_0.c:127   in BlitBto3\n\r");
    int c, o;
    int width, height;
    Uint8 *src, *map, *dst;
    int srcskip, dstskip;
...
{
	xil_printf("SDL_blit_0.c:167   in BlitBto4\n\r");
    int width, height;
    Uint8 *src;
    Uint32 *map, *dst;
    int srcskip, dstskip;
...
{
	xil_printf("SDL_blit_0.c:205   in BlitBto1Key\n\r");
...
{
	xil_printf("SDL_blit_0.c:259   in BlitBto2Key\n\r");
    int width = info->dst_w;
    int height = info->dst_h;
    Uint8 *src = info->src;
...
{
	xil_printf("SDL_blit_0.c:295   in BlitBto3Key\n\r");
    int width = info->dst_w;
    int height = info->dst_h;
    Uint8 *src = info->src;
    Uint8 *dst = info->dst;
...
{
	xil_printf("SDL_blit_0.c:330   in BlitBto4Key\n\r");
    int width = info->dst_w;
    int height = info->dst_h;
    Uint8 *src = info->src;
...
{
	xil_printf("SDL_blit_0.c:366   in BlitBtoNAlpha\n\r");
    int width = info->dst_w;
    int height = info->dst_h;
    Uint8 *src = info->src;
    Uint8 *dst = info->dst;
...
{
	xil_printf("SDL_blit_0.c:412  in BlitBtoNAlphaKey\n\r");
    int width = info->dst_w;
    int height = info->dst_h;
    Uint8 *src = info->src;
    Uint8 *dst = info->dst;
...
{
	xil_printf("SDL_blit_0.c:469  in Blit4bto4\n\r");
    int width = info->dst_w;
    int height = info->dst_h;
    Uint8 *src = info->src;
...
{
	xil_printf("SDL_blit_0.c:503  in Blit4bto4Key\n\r");
    int width = info->dst_w;
    int height = info->dst_h;
    Uint8 *src = info->src;
    Uint32 *dst = (Uint32 *) info->dst;
...
{
	xil_printf("SDL_blit_0.c:526   in SDL_CalculateBlit0\n\r");
    int which;

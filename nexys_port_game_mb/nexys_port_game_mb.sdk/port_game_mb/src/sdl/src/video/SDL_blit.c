...
{
	if(XIL_PRINTF_EN == 1) xil_printf("SDL_blit.c:37 in SDL_SoftBlit \n\r");
    int okay;
    int src_locked;
    int dst_locked;
    ...
    if(XIL_PRINTF_EN == 1) xil_printf("   in SDL_SoftBlit: lock 1 \n\r");
    ...
    //xil_printf("   in SDL_SoftBlit: lock 2 \n\r");
    ...
    if(XIL_PRINTF_EN == 1) xil_printf("   in SDL_SoftBlit: work \n\r");
    ...
    if (okay && !SDL_RectEmpty(srcrect)) {
        ...
        info->dst_skip = info->dst_w * info->dst_fmt->BytesPerPixel;
        RunBlit = (SDL_BlitFunc) src->map->data;

        if(XIL_PRINTF_EN == 1) xil_printf("   in SDL_SoftBlit: RunBlit(info)\n\r");
        /* Run the actual software blit */
        RunBlit(info);
    }

    if(XIL_PRINTF_EN == 1) xil_printf("   in SDL_SoftBlit: UNlock \n\r");
...
{
	if(XIL_PRINTF_EN == 1) xil_printf("SDL_blit.c:139   in SDL_ChooseBlitFunc\n\r");
...
{
	if(XIL_PRINTF_EN == 1) xil_printf("SDL_blit.c:198 in SDL_CalculateBlit \n\r");

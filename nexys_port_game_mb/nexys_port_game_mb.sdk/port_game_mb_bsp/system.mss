...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = any_reg_space_timer
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = key_driver_pb
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = key_driver_pb_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = accelerator_Blit1to2
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = accelerator_Blit1to2_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.9
 PARAMETER HW_INSTANCE = axi_dma_Acselerarot
END
